...
1. Скачайте архив **pdf.zip** из раздела [Releases](../../releases) — там готовые PDF для печати.
2. Распакуйте и отправьте PDF в печать — в типографию или на домашнем принтере на плотной бумаге.
3. Формат карт — **63×88 мм** (стандартный), вылет 2мм.

Если хотите доработать под себя — откройте проекты Affinity из архива Affinity.zip (в них последние изменения и убрано скругление под обрез), поменяйте что нужно и переэкспортируйте. Для этого всё и выложено.
